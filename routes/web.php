...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('checkpayment/', [\App\Http\Controllers\PaymentCheckController::class, 'checkpayment'])->name('checkpayment');
    Route::get('checkpayment/first/', [\App\Http\Controllers\PaymentCheckController::class, 'checkpayment'])->name('checkpayment.first');
});
